// ====================================================================
// 主框架導航 (Main Frame Navigation)
// ====================================================================
// 這個檔案包含應用程式的主要導航框架和底部選單
...
// 暫時從 main.dart 導入（待模組化完成後移至各自的 features 資料夾）
import '../../main.dart'; // 用於存取 FoodDiaryPageContent 和 CameraScreen
  ...
  Widget _buildCurrentPage() {
    ...
    switch (_currentPage) {
      ...
      case AppPage.foodDiary: // 飲食記錄情況
        print('返回飲食日記內容'); // 除錯訊息
        return const FoodDiaryPageContent();
