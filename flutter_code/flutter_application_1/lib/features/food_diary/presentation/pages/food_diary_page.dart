...
class _FoodDiaryPageContentState extends State<FoodDiaryPageContent> {
  ...
  void initState() {
    super.initState();
    // Initialize date pickers in the ViewModel
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<FoodDiaryViewModel>(context, listen: false).initDatePickers();
    });
  }

  @override
  void dispose() {
    // Dispose controllers from the ViewModel
    Provider.of<FoodDiaryViewModel>(context, listen: false).disposeDatePickers();
    super.dispose();
  }
